...
public interface DiagnosticExecutionService {
    ...
    ImagingDTO registerImaging(ImagingDTO imagingDTO);
    ...
    EndoscopyDTO registerEndoscopy(EndoscopyDTO endoscopyDTO);
    ...
    PathologyDTO registerPathology(PathologyDTO pathologyDTO);
    ...
    PhysiologicalDTO registerPhysiological(PhysiologicalDTO physiologicalDTO);
