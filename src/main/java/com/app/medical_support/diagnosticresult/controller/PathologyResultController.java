...
public class PathologyResultController {
    ...
    @Operation(summary = "병리 검사 결과 목록 조회")
    @GetMapping
    ...
    @Operation(summary = "병리 검사 결과 단건 조회")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "병리 검사 결과 등록")
    @PostMapping
    public ResponseEntity<ApiResponse<PathologyResultDTO>> register(@RequestBody PathologyResultDTO dto) {
    ...
    @Operation(summary = "병리 검사 결과 수정")
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PathologyResultDTO>> modify(@PathVariable String id, @RequestBody PathologyResultDTO dto) {
    ...
    @Operation(summary = "병리 검사 결과 비활성화")
    @DeleteMapping("/{id}")
