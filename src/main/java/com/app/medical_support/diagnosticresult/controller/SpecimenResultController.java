...
public class SpecimenResultController {
    ...
    @Operation(summary = "검체 검사 결과 목록 조회")
    @GetMapping
    ...
    @Operation(summary = "검체 검사 결과 단건 조회")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "검체 검사 결과 등록")
    @PostMapping
    public ResponseEntity<ApiResponse<SpecimenTestResultDTO>> register(@RequestBody SpecimenTestResultDTO dto) {
        return ResponseEntity.ok(new ApiResponse<>(true, "Specimen result created.", diagnosticResultService.registerSpecimenResult(dto)));
    }

    @Operation(summary = "검체 검사 결과 수정")
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<SpecimenTestResultDTO>> modify(@PathVariable String id, @RequestBody SpecimenTestResultDTO dto) {
    ...
    @Operation(summary = "검체 검사 결과 비활성화")
    @DeleteMapping("/{id}")
