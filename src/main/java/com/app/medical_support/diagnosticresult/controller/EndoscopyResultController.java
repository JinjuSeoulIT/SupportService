...
public class EndoscopyResultController {
    ...
    @Operation(summary = "내시경 검사 결과 목록 조회")
    @GetMapping
    ...
    @Operation(summary = "내시경 검사 결과 단건 조회")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "내시경 검사 결과 등록")
    @PostMapping
    public ResponseEntity<ApiResponse<EndoscopyResultDTO>> register(@RequestBody EndoscopyResultDTO dto) {
    ...
    @Operation(summary = "내시경 검사 결과 수정")
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<EndoscopyResultDTO>> modify(@PathVariable String id, @RequestBody EndoscopyResultDTO dto) {
    ...
    @Operation(summary = "내시경 검사 결과 비활성화")
    @DeleteMapping("/{id}")
